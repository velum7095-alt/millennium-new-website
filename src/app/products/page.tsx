        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
              <span className="gradient-text">Our Products & Solutions</span>
            </h1>
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              We offer a wide selection of genuine, enterprise-grade technology equipment and infrastructure. Request a price or browse models below.
            </p>
          </motion.div>

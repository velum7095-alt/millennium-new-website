...
export const initialProducts: Product[] = [
  { id: '1', name: 'HP EliteBook 840 G9', category: 'laptops', description: 'Premium business laptop with Intel Core i7, 16GB RAM, 512GB SSD.', image: '', price: 'Contact for Price', features: ['Intel Core i7-1260P', '16GB DDR5 RAM', '512GB NVMe SSD', '14" FHD Display', 'Windows 11 Pro'], isFeatured: true, brand: 'HP' },
  { id: '2', name: 'Lenovo ThinkPad T14s', category: 'laptops', description: 'Ultra-thin business laptop with AMD Ryzen processor.', image: '', price: 'Contact for Price', features: ['AMD Ryzen 7 PRO', '16GB RAM', '512GB SSD', '14" IPS Display', 'Fingerprint Reader'], isFeatured: true, brand: 'Lenovo' },
  { id: '3', name: 'HP ProDesk 400 G7', category: 'desktops', description: 'Reliable business desktop for everyday office computing.', image: '', price: 'Contact for Price', features: ['Intel Core i5', '8GB RAM', '256GB SSD', 'Windows 10 Pro'], isFeatured: false, brand: 'HP' },
  { id: '4', name: 'HP LaserJet Pro M404dn', category: 'printers', description: 'Fast mono laser printer with automatic double-sided printing.', image: '', price: 'Contact for Price', features: ['40 ppm', 'Automatic Duplex', 'Network Ready', '250-sheet Tray'], isFeatured: true, brand: 'HP' },
  { id: '5', name: 'Canon imageRUNNER 2625i', category: 'photocopiers', description: 'Multifunction office photocopier with print, copy, scan capabilities.', image: '', price: 'Contact for Price', features: ['25 ppm', 'Color Scanning', 'Double-sided', 'Network Ready'], isFeatured: false, brand: 'Canon' },
  { id: '6', name: 'Hikvision DS-2CD2T47G2-L', category: 'cctv-surveillance', description: '4MP AcuSense network camera with smart detection.', image: '', price: 'Contact for Price', features: ['4MP Resolution', 'AcuSense AI', 'Night Vision 50m', 'IP67'], isFeatured: true, brand: 'Hikvision' },
  { id: '7', name: 'Cisco Catalyst 2960-X', category: 'network-switches', description: 'Enterprise-grade managed network switch.', image: '', price: 'Contact for Price', features: ['24 Ports', 'Layer 2 Managed', 'PoE+ Support', 'Stackable'], isFeatured: true, brand: 'Cisco' },
  { id: '8', name: 'Cisco ISR 1000 Series', category: 'routers', description: 'Integrated services router for business networks.', image: '', price: 'Contact for Price', features: ['VPN Support', 'SD-WAN Ready', 'Security Built-in'], isFeatured: false, brand: 'Cisco' },
  { id: '9', name: 'Seagate IronWolf 4TB', category: 'storage-devices', description: 'NAS-optimized hard drive for always-on storage.', image: '', price: 'Contact for Price', features: ['4TB Capacity', 'NAS Optimized', '7200 RPM', '3-Year Warranty'], isFeatured: false, brand: 'Seagate' },
  { id: '10', name: 'APC Smart-UPS 1500VA', category: 'ups-systems', description: 'Intelligent UPS for critical equipment protection.', image: '', price: 'Contact for Price', features: ['1500VA', 'LCD Display', 'Network Card Slot', 'Green Mode'], isFeatured: false, brand: 'APC' },
];

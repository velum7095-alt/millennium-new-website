  ...
  return (
    ...
    >
        ...
        {latestPosts.map((post, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-red-400 transition-colors line-clamp-2">{post.title}</h3>
      ...
      <div className="text-center mt-12">
        <a href="/blog" className="inline-flex items-center gap-2 glass px-6 py-3 rounded-xl text-slate-900 font-medium hover:bg-slate-100 transition-colors">
          View All Articles
        </a>
      </div>
    </SectionWrapper>

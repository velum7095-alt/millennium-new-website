  ...
  return (
    ...
    >
            ...
            <GlassCard className="h-full flex flex-col">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {product.features.slice(0, 3).map((feature, i) => (
                    <span key={i} className="text-xs bg-slate-50 text-text-secondary px-2 py-1 rounded-md flex items-center gap-1">
              ...
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-200">
                ...
                <div className="flex gap-2">
                  <button onClick={() => setSelectedProduct(product)} className="glass w-9 h-9 rounded-lg flex items-center justify-center hover:bg-slate-100 transition-colors">
      ...
      <div className="text-center mt-12">
        <a href="https://wa.me/25765001555?text=${encodeURIComponent('Hello Millennium Infosys! I would like to inquire about your products.')}" target="_blank" rel="noopener noreferrer" className="glass px-6 py-3 rounded-xl text-slate-900 font-medium hover:bg-slate-100 transition-colors inline-flex items-center gap-2">View All Products</a>
      </div>
    </SectionWrapper>
  );
}